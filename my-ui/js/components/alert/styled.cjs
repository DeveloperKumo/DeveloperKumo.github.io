module.exports = {
  ...
  ".alert-primary": {
    "borderColor": "rgba(var(--ice-primary) / 0.2)",
    "--tw-bg-opacity": "1",
  ...
  ".alert-success": {
    "borderColor": "rgba(var(--ice-success) / 0.2)",
    "--tw-bg-opacity": "1",
  ...
  ".alert-warning": {
    "borderColor": "rgba(var(--ice-warning) / 0.2)",
    "--tw-bg-opacity": "1",
  ...
  ".alert-error": {
    "borderColor": "rgba(var(--ice-error) / 0.2)",
    "--tw-bg-opacity": "1",
  ...
  ".alert-neutral": {
    "borderColor": "rgba(var(--ice-neutral) / 0.2)",
    "--tw-bg-opacity": "1",
